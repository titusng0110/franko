...
public class FrankoLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"ALLOC", "DEL", "PRINT", "UNINIT", "MEMSET", "MEMCPY", "INT32_T", "UINT32_T", 
			"FLOAT32_T", "CHAR8_T", "ARRAY", "ASSIGN", "PLUS", "MINUS", "STAR", "SLASH", 
			"DOT", "COMMA", "SEMI", "LT", "GT", "LPAREN", "RPAREN", "LBRACK", "RBRACK", 
			"IDENTIFIER", "INT_LITERAL", "COMMENT", "WS", "NEWLINE"
		};
	}
